...
const NavBar = () => {
        ...
        <div className="container">
            ...
            <nav className="navegador" >
                <ul>
                    ...
                    <li className="login"><NavLink to='/Login' className={({isActive})=> isActive ? "flex items-center border-b-2 border-blue-700 hover:border-b-2 hover:border-blue-700 transition duration-700" : "flex items-center"  }><div className="logo"></div>Login</NavLink></li>
                </ul>
            </nav>
        </div>
    </div> */}
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-400 dark:border-gray-700">
